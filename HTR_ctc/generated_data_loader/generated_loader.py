    ...
    def __init__(self, set = 'train', augment_factor = 0, resize = False, nr_of_channels=1, fixed_size=(128, None), generator_path = '', source_dataset = 'EG-BG-LC', save_path = ''):
        ...
        if isfile(save_file) is False or generate_data:
            ...
            while len(data) < min_len:
                try:
                    data.extend(generateCrops(nr_of_channels,'/content/drive/MyDrive/Github/Generating-Synthetic-Handwritten-Historical-Documents/HTR_ctc/data/generated/', just_generate=False, generator_path=generator_path, source_dataset= source_dataset))
                except:
